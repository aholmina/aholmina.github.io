    ...
    bookmarks.forEach(bookmark => {
        ...
        li.innerHTML = `
            <a href="${bookmark.url}" target="_blank" class="text-decoration-none">
                <img src="${bookmark.image || 'https://via.placeholder.com/40?text=No+Image'}" alt="${bookmark.title}" class="rounded-circle me-2" width="40" height="40">
                ${bookmark.title}
            </a>
            <button class="btn btn-sm btn-outline-danger remove-bookmark-btn" data-url="${bookmark.url}">
